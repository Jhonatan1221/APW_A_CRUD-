...
<html lang="en">
  ...
  <body>
    ...
    <div style="background-color: yellow">
     <h5 style="text-align: center">Luis Miguel Cruz Linares</h5>
    </div>
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        ...
        <p class="mg-b-0">Desde esta venta podrá dar mantenimiento a productos</p>
      </div>

      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Mantenimiento de Productos</h6>
          <button id="bntnuevo" class="btn btn-outline-primary btn-block mg-b10">Nuevo registro</button>
